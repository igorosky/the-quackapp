...
### Using Xcode
1. Open `TheQuackApp.xcodeproj` in Xcode
2. Select the test target scheme
...
TheQuackApp/
├── TheQuackAppTests/
│   ├── UnitTests.swift          # Model and data type tests
│   └── IntegrationTests.swift   # Component interaction tests
└── TheQuackAppUITests/
    └── UITests.swift            # UI and navigation tests
```

## Dependencies

- **XCTest** - Apple's testing framework
- **Combine** - For testing reactive publishers in integration tests
